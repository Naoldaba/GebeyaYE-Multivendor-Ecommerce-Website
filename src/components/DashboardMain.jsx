...
const DashboardMain = ({ activeMenu, products }) => {
  let content = null;
  ...
  switch (activeMenu) {
    case 'products':
        ...
        <div className="products flex flex-wrap justify-center items-center">
            <h2 className='w-full text-4xl text-center my-6'>Product List</h2>
    ...
    case 'addProduct':
      content = (
        <div className='w-full'>
            <h2 className='text-4xl text-center mb-20'>Add Product Form</h2>
            <form className='w-1/3 mx-auto flex flex-col gap-4'>
              <p className='text-2xl'>Uplaod Photo</p>
              ...
              <label className='text-2xl'>Write Description<textarea type="text" className='w-full resize-none'></textarea></label>
              <label className='text-2xl'>Specifiy Price<input className='w-full' type="number"/></label>
              <button className='bg-blue-500 p-2 text-white mt-5'>Post</button>
            </form>
