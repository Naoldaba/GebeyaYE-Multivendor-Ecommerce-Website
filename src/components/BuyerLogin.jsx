        ...
        <>
            <div className="w-4/5 my-8">
                ...
                <div className='relative'>
                    ...
                    <input className="w-full border-none pl-6 focus:outline-none" type="text" placeholder="Enter user name" required/>
                </div>
            </div>
            ...
            <div className="w-4/5">
                ...
                <div className='relative'>
                    ...
                    <input className="border-none w-full pl-6" type={showPassword ? 'text' : 'password'} placeholder="Enter password" required onChange={(e) => setPassword(e.target.value)}/>
