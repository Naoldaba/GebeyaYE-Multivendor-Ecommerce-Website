    ...
    return (
        ...
        <>
            ...
            <div className="w-4/5 mb-5">
                ...
                <input className="w-full" type="file" placeholder="Upload licence" required/>
            </div>
            <div className="w-4/5 mb-5">
                <label className="block mb-2 text-lg">Profile Picture</label>
                <input className="w-full" type="file" name="image" accept="image/*" placeholder="Upload licence" required/>
            </div>
